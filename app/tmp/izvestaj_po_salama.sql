SELECT ter.sala_id, sale.naziv, ter.datum, SUM(ugo.ug_broj_mesta) AS broj_mesta, SUM((ugo.ug_iznos_meni + ugo.ug_iznos_usluge)) AS iznos, SUM(ugo.ug_uplate_iznos) AS uplate_iznos,
